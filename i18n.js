...
var RC_STRINGS = {
  tr: {
    ...
    card_cloud_sync: 'Bulut Eşitleme',
    toggle_sync_lbl: 'Otomatik Eşitleme',
    sync_pwd_lbl: 'Eşitleme Şifresi:',
    sync_btn_now: 'Şimdi Eşitle',
    sync_status_idle: 'Eşitleme yapılmadı',
    sync_help_modal_title: 'Bulut Eşitleme Kılavuzu',
    sync_help_desc: "RollerCoin oturumunuzun buluttaki otomasyon sunucunuzda (Hugging Face) kesintisiz çalışması için token'larınızı uçtan uca şifreli (E2EE) olarak senkronize eder.",
    sync_help_steps_title: 'Adım Adım Yapılması Gerekenler:',
    sync_help_step1: "Eşitleme Şifresi'nin yanındaki kopyalama butonuna tıklayarak otomatik üretilen şifreyi kopyalayın.",
    sync_help_step2: 'Hugging Face Space ayarlarınızdan (Settings -> Variables and Secrets) <strong>SYNC_PASSWORD</strong> adında yeni bir secret oluşturup kopyaladığınız şifreyi değer kısmına yapıştırın.',
    sync_help_step3: 'Eklentide <strong>Otomatik Eşitleme</strong> seçeneğini aktif edin.',
    sync_help_step4: '<strong>Space URL</strong> alanına Hugging Face Space uygulamanızın adresini girin (örn. <code>https://kullanici-space.hf.space</code>).',
    sync_help_step5: '*(Opsiyonel)* Space alanınız <strong>Private</strong> ise, <strong>HF Token</strong> alanına Hugging Face\'ten aldığınız access token\'ı girin.',
    sync_help_step6: '<strong>Şimdi Eşitle</strong> butonuna basarak ilk eşitlemeyi tamamlayın. Eklenti, RollerCoin sekmelerinde oturumunuz açıkken token\'larınızı arka planda güncel tutacaktır.',
  ...
  en: {
    ...
    card_cloud_sync: 'Cloud Sync',
    toggle_sync_lbl: 'Auto Sync',
    sync_pwd_lbl: 'Sync Password:',
    sync_btn_now: 'Sync Now',
    sync_status_idle: 'Not synced yet',
    sync_help_modal_title: 'Cloud Sync Guide',
    sync_help_desc: 'It synchronizes your RollerCoin session tokens to your cloud automation server (Hugging Face) using End-to-End Encryption (E2EE) to prevent session expiration.',
    sync_help_steps_title: 'Step-by-Step Guide:',
    sync_help_step1: 'Click the copy button next to the automatically generated Sync Password to copy it.',
    sync_help_step2: 'Go to the Settings -> Variables and Secrets section of your Hugging Face Space, click New Secret to create a secret named <strong>SYNC_PASSWORD</strong>, and paste the copied password.',
    sync_help_step3: 'Enable the <strong>Auto Sync</strong> option in the extension.',
    sync_help_step4: 'Enter your Hugging Face Space URL in the <strong>Space URL</strong> field (e.g., <code>https://username-space.hf.space</code>).',
    sync_help_step5: '*(Optional)* If your Space is <strong>Private</strong>, enter your Hugging Face Access Token under the HF Token field.',
    sync_help_step6: 'Click <strong>Sync Now</strong> to complete the first synchronization. The extension will keep your tokens updated in the background as long as you are logged in.',
