...
var RC_STRINGS = {
  tr: {
    ...
    sync_help_text: "Bulut Eşitleme Nedir?\nRollerCoin oturumunuzun buluttaki otomasyon sunucunuzda (Hugging Face) kesintisiz çalışması için token'larınızı uçtan uca şifreli (E2EE) olarak senkronize eder.\n\nAdım Adım Yapılması Gerekenler:\n1. Hugging Face Space alanınızın 'Settings -> Variables and Secrets' kısmına gidin.\n2. 'New Secret' butonuna basarak 'SYNC_PASSWORD' adında bir değişken oluşturun.\n3. Eklenti üzerindeki 'Eşitleme Şifresi'nin yanındaki butona tıklayarak otomatik üretilen şifreyi kopyalayın ve HF Space'e değer olarak yapıştırıp kaydedin.\n4. Eklentide 'Otomatik Eşitleme'yi aktif edin.\n5. 'Space URL' alanına Hugging Face Space adresinizi (örn. https://kullanici-space.hf.space) yazın.\n6. 'Şimdi Eşitle' butonuna basarak ilk eşitlemeyi tamamlayın. Eklenti, RollerCoin sekmelerinde oturumunuz açıkken token'larınızı arka planda güncel tutacaktır.",
  ...
  en: {
    ...
    sync_help_text: "What is Cloud Sync?\nIt synchronizes your RollerCoin session tokens to your cloud automation server (Hugging Face) using End-to-End Encryption (E2EE) to prevent session expiration.\n\nStep-by-Step Guide:\n1. Go to the 'Settings -> Variables and Secrets' section of your Hugging Face Space.\n2. Click 'New Secret' and create a secret named 'SYNC_PASSWORD'.\n3. Copy the automatically generated password by clicking the copy button next to 'Sync Password' in the extension, and paste it as the value in HF Space.\n4. Enable 'Auto Sync' in the extension.\n5. Enter your Hugging Face Space URL in the 'Space URL' field (e.g. https://username-space.hf.space).\n6. Click 'Sync Now' to complete the first synchronization. The extension will keep your tokens updated in the background as long as you are logged in.",
